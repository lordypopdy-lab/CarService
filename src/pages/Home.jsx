            ...
            <nav className="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
                ...
                <div className="collapse navbar-collapse" id="navbarCollapse">
                    <div className="navbar-nav ms-auto p-4 p-lg-0">
                        ...
                        <Link to="/Diagnose" className="nav-item nav-link">Diagnose</Link>
                    </div>
                                ...
                                <div className="container">
                                    <div className="row align-items-center justify-content-center justify-content-lg-start">
                                        <div className="col-10 col-lg-7 text-center text-lg-start">
                                            ...
                                            <Link to="Diagnose" className="btn btn-primary py-3 px-5 animated slideInDown">Start Now<i className="fa fa-arrow-right ms-3"></i></Link>
                                        </div>
                        ...
                        <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div className="d-flex py-5 px-4">
                                ...
                                <div className="ps-4">
                                    ...
                                    <Link className="text-secondary border-bottom" to="/Diagnose">Diagnose Now</Link>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                            <div className="d-flex py-5 px-4">
                                ...
                                <div className="ps-4">
                                    ...
                                    <Link to="Diagnose" className="btn btn-primary py-3 px-5 animated slideInDown">Diagnose<i className="fa fa-arrow-right ms-3"></i></Link>
                                </div>
                            </div>
                        </div>
                    </div>
