                ...
                <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div className="d-flex py-5 px-4">
                        ...
                        <div className="ps-4">
                            ...
                            <a className="text-secondary border-bottom" href="/CarService/Diagnose">Diagnose Now</a>
                        </div>
                    </div>
                </div>
        ...
        <div className="container">
            <div className="row g-5">
                ...
                <div className="col-lg-6">
                    ...
                    <a href="/CarService/Diagnose" className="btn btn-primary py-3 px-5">Diagnose Now<i className="fa fa-arrow-right ms-3"></i></a>
                </div>
            </div>
        </div>
    </div>
